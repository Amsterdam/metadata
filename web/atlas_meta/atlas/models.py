...
class MetaData(models.Model):
    ...
    title = models.CharField(max_length=100, null=True, blank=True, help_text='Titel thema')
    ...
    data_modified_date = models.CharField(max_length=100, null=True, blank=True,
